...
td <- make.treedata(tree, morph_paramo)
...
EntPhen.maps <- EP.maps



save(Qmats, file = "paramo/Qmats_map.RData")
save(IND.maps, file = "paramo/INDmaps_map.RData")
save(EntPhen.maps, file = "paramo/EntPhenmaps_map.RData")
...
source("~/Documents/underground_evo/paramo/plot_simmap.R")
